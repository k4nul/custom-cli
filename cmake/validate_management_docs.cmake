...
set(VALIDATION_SCRIPT "${REPO_ROOT}/tests/validate_management_docs.py")
...
execute_process(
    COMMAND ${PYTHON_COMMAND} "${VALIDATION_SCRIPT}"
    WORKING_DIRECTORY "${REPO_ROOT}"
    RESULT_VARIABLE VALIDATION_EXIT_CODE
)

if(NOT VALIDATION_EXIT_CODE EQUAL 0)
    message(FATAL_ERROR "Management-doc validation failed with exit code ${VALIDATION_EXIT_CODE}.")
endif()
